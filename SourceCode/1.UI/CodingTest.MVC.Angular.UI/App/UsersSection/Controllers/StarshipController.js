...
(function (StarshipModule) {
    ...
    (function (Controllers) {
        ...
        StarshipController.$inject = ["$injector", "StarshipModule.Services.StarshipService"];
        Controllers.StarshipController = StarshipController;
        MiniSpas.ModuleInitiator.GetModule("StarshipModule").controller("StarshipModule.Controllers.StarshipController", StarshipController);
    })(Controllers = StarshipModule.Controllers || (StarshipModule.Controllers = {}));
